...
/**
 * Called every time user perform left click on balloon
 *
 ...
 */
@MessageData.Tag("gui-events:balloon-left-click")
class BalloonLeftClick(val screenX: Int, val screenY: Int, val nodeX: Int, val nodeY: Int) : MessageData