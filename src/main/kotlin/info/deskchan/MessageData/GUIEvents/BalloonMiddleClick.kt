...
/**
 * Called every time user perform middle click on balloon
 *
 ...
 */
@MessageData.Tag("gui-events:balloon-middle-click")
class BalloonMiddleClick(val screenX: Int, val screenY: Int, val nodeX: Int, val nodeY: Int) : MessageData