...
/**
 * Called every time user perform middle button scroll on character
 *
 ...
 */
@MessageData.Tag("gui-events:character-scroll")
class CharacterScroll(val screenX: Int, val screenY: Int, val nodeX: Int, val nodeY: Int, val delta: Int) : MessageData