...
С помощью параметра columnGrow можно регулировать
соотношение места, выделяемого под подписи и сами элементы
управления. По умолчанию он равен 0.5, поэтому столбцы
выравниваются с соотношением 1:1. Допустимые значения
